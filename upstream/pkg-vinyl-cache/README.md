# Packaging files for Vinyl Cache

This repository contains the necessary scripts to package up Vinyl Cache.

The transition to Vinyl Cache after the rename is not yet done.
...
2) Put the Vinyl Cache .tar.gz archive into sources/.

3) Run ./package-deb or ./package-rpm.

## Branch structure

This repository will contain a main branch and zero or more
maintenance branches.

main should be used to build the last stable release _and_ the development
