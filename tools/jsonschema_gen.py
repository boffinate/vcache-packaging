...
def build_engines() -> dict:
    ...
    target = _object(
        "target",
        {
            ...
            "runner": _string("Default GitHub Actions runner label for this target."),
            "build_runner": _string("GitHub Actions runner label for CPU-intensive builds on this target."),
    ...
    return _document(
        "engines_doc",
        {
            ...
            "targets": {
                ...
                "additionalProperties": False,
                "description": "Target registry: image, package format, default and build runners, and architecture.",
            },
