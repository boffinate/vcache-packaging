...
def build_engines() -> dict:
    ...
    target = _object(
        "target",
        {
            ...
            "runner": _string("GitHub-hosted runner label for this target."),
    ...
    return _document(
        "engines_doc",
        {
            ...
            "targets": {
                ...
                "additionalProperties": False,
                "description": "Target registry: image, package format, native GitHub-hosted runner, and architecture.",
            },
    ...
    return _document(
        "vmod_doc",
        {
            ...
            "source_api_family": _string(
                "API family named by this source tree. Cross-family Cargo builds use private SDK name aliases; "
                "Autotools builds normalize explicit family spellings before bootstrap.",
